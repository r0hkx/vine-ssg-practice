...
# if the player is in the overworld portal reset
execute at @e[tag=OverworldSpawn] at @p run execute if block ~ ~ ~ nether_portal run function vinedp:testfor/portal
