...
data modify block -999 100 -991 Items set from storage minecraft:store3 Inventory

# get items from main shulker box
loot replace entity @s container.0 mine -999 100 -991 air{drop_contents:1b}

# get item from offhand box
loot replace entity @s weapon.offhand mine -1001 101 -993 air{drop_contents:1b}
