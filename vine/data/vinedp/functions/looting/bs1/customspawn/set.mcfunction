...
tp @s @e[tag=BS1CustomSpawn, limit=1]
gamemode adventure @s
function vinedp:util/killitems

function vinedp:looting/bs1/customspawn/giveitem/lily_pad
function vinedp:looting/bs1/customspawn/giveitem/compass
function vinedp:looting/bs1/customspawn/giveitem/netherite
function vinedp:looting/bs1/customspawn/giveitem/barrier
