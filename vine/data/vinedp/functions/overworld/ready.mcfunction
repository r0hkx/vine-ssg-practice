...
#potential warnings
execute if score @s OWSplits matches 1 if score @s savePBs matches 0 if score @s OWCustomSpawn matches 0 run tellraw @a [{"text":"Warning: The \"Save PBs\" setting is disabled.","color":"red"}]
execute if score @s OWSplits matches 1 if score @s savePBs matches 1 if score @s OWCustomSpawn matches 1 run tellraw @a [{"text":"Warning: The \"Save PBs\" setting is enabled, even though you are using a custom spawn.","color":"red"}]
