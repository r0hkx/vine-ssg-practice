...
scoreboard players operation pb timerDecimal %= @p ONE_THOUSAND
execute if score pb timerDecimal matches 100.. run data merge block 996 112 -4 {Text2:'[{"text":"Overworld","color":"#02F8A2"},{"text":": ","color":"gray"},{"score":{"name":"pb","objective":"timerInteger"},"color":"#E4BE3C"},{"text":".","color":"#E4BE3C"},{"score":{"name":"pb","objective":"timerDecimal"},"color":"#E4BE3C"}]'}
execute if score pb timerDecimal matches 50 run data merge block 996 112 -4 {Text2:'[{"text":"Overworld","color":"#02F8A2"},{"text":": ","color":"gray"},{"score":{"name":"pb","objective":"timerInteger"},"color":"#E4BE3C"},{"text":".","color":"#E4BE3C"},{"text":"050","color":"#E4BE3C"}]'}
execute if score pb timerDecimal matches 0 run data merge block 996 112 -4 {Text2:'[{"text":"Overworld","color":"#02F8A2"},{"text":": ","color":"gray"},{"score":{"name":"pb","objective":"timerInteger"},"color":"#E4BE3C"},{"text":".","color":"#E4BE3C"},{"text":"000","color":"#E4BE3C"}]'}
...
scoreboard players operation pb timerDecimal %= @p ONE_THOUSAND
execute if score pb timerDecimal matches 100.. run data merge block 996 112 -7 {Text2:'[{"text":"| ","color":"gray"},{"score":{"name":"pb","objective":"timerInteger"},"color":"#ff6d38"},{"text":".","color":"#ff6d38"},{"score":{"name":"pb","objective":"timerDecimal"},"color":"#ff6d38"}]'}
execute if score pb timerDecimal matches 50 run data merge block 996 112 -7 {Text2:'[{"text":"| ","color":"gray"},{"score":{"name":"pb","objective":"timerInteger"},"color":"#ff6d38"},{"text":".","color":"#ff6d38"},{"text":"050","color":"#ff6d38"}]'}
execute if score pb timerDecimal matches 0 run data merge block 996 112 -7 {Text2:'[{"text":"| ","color":"gray"},{"score":{"name":"pb","objective":"timerInteger"},"color":"#ff6d38"},{"text":".","color":"#ff6d38"},{"text":"000","color":"#ff6d38"}]'}