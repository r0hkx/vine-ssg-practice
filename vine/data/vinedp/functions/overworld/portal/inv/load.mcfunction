...
data modify block -995 100 -991 Items set from storage minecraft:store2 Inventory

# get items from main shulker box
loot replace entity @s container.0 mine -995 100 -991 air{drop_contents:1b}

# get item from offhand box
loot replace entity @s weapon.offhand mine -997 101 -993 air{drop_contents:1b}
